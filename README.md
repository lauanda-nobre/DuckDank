...
O **DuckDank** não é apenas um oponente estático. Ele foi programado para ter "vida própria" durante a partida. Em vez de uma lógica simples, utilizei JavaScript para criar um comportamento imprevisível e interativo, um verdadeiro jogador de jogo da velha.
...
## Evolução Visual
Para documentar o progresso, aqui está o comparativo entre a concepção e a entrega final:
